...
public class BlushProduct implements MakeupProduct {

    private final ProductDataMakeUp data;

    public BlushProduct(ProductDataMakeUp data) {
        this.data = data;
    }
    ...
    public void save() {
        try {
            ...
            ps.setString(17, data.powderOrCream);
            ps.setString(18, data.shimmer);
