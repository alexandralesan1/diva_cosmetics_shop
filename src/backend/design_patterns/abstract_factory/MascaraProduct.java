...
public class MascaraProduct implements MakeupProduct {

    private final ProductDataMakeUp data;

    public MascaraProduct(ProductDataMakeUp data) {
        this.data = data;
    }
        ...
        try {
            ...
            String sql = """
                ...
                (name, age_category, brand, product_series, product_range, purpose,
                 ...
                 volume_effect, brush_type, waterproof)
                VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
            """;
            ...
            ps.setString(16, data.volumeEffect);
            ps.setString(17, data.brushType);
            ps.setString(18, data.waterproof);
